...
export default function StagedCardList({ jobs, stage = 'staged', crewByCallLog = {}, matsByJobId = {}, logsByCallLog = {}, assignmentsByJobId = {}, proposalMaterialsByCallLog = {}, mobsByJobId = {}, prtMap = new Map(), today = new Date(), onJobUpdate, emptyText = 'No staged jobs' }) {
