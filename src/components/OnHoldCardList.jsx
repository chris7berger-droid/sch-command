...
export default function OnHoldCardList({ filteredJobs, jobs, setJobs, billingLog, setBillingLog, today, crewByCallLog = {}, matsByJobId = {}, logsByCallLog = {}, assignmentsByJobId = {}, prtMap = new Map(), onJobUpdate }) {
